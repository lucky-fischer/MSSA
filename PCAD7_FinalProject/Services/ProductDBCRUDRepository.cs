...
{
    public class ProductDBCRUDRepository : IProduct
    {
        private ProductContext? _productContext;
        public ProductDBCRUDRepository(ProductContext? productContext) // this productContext is like a presentation of our db on application side
        {
