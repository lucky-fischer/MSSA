...
//builder.Services.AddSingleton<IProduct, ProductRepository>(); //this is for in memory list.
builder.Services.AddScoped<IProduct, DBCRUDRepository>(); //register of services for db.
builder.Services.AddScoped<IFileUploadService, FileUploadService>();
//builder.Services.AddDbContext<ProductContext>(options => options.UseSqlServer("Server=LAPTOP-localhost;Datbase=PCAD7Product;Trusted_Connection=true;MultipleActiveResultSets=True"));
